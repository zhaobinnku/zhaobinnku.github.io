...
- <strong>Zhao Bin</strong>#, Teng Shougan#, Wenwen Min, Changmiao Wang* and Zhenbing Liu*. RE-SAM2: Boosting Few-Shot Medical Image Segmentation via Reinforcement Learning and Ensemble Learning[C].<strong>2025 IEEE International Conference on Bioinformatics and Biomedicine (BIBM 2025)</strong>.[[Paper]](https://doi: 10.1109/BIBM66473.2025.11356746)[[code]](https://github.com/zzzzz37/RE-SAM2)
