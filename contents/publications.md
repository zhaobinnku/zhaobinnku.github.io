...
-  Xiong Chuan#,   __Zhao Bin*#__, Wang Chunshi,  Ding Shuxue* (2025). Domain Generalization with Amplitude-based Data Generation and Feature Random Suppression[J]. <strong>IEEE Transactions on Neural Networks and Learning Systems</strong>. [[Paper]](https://doi.org/10.1109/TNNLS.2025.3625446)[[code]](https://github.com/butterflyGN/DGSFTAFS)

-  Xiong Chuan,   __Zhao Bin*__,  Ding Shuxue* (2025). DGAA: Domain Generalization with Amplitude Alignment[J]. <strong>Biomedical Signal Processing and Control</strong>. [[Paper]](https://doi.org/10.1016/j.bspc.2025.109050)[[code]](https://github.com/butterflyGN/DGAA)

-  Wang Chunshi#, Xiong Chuan#,  <strong>Zhao Bin*</strong>,  Ding Shuxue(2025). CycleMatch: Cyclic pseudo-labeling distillation in semi-supervised medical image segmentation[J]. <strong>Pattern Recognition Letters</strong>. [[Paper]](https://doi.org/10.1016/j.patrec.2025.04.014)
...
- <strong>Zhao Bin</strong>#, Teng Shougan#, Min Wenwen, Wang Changmiao* and Liu Zhenbing*. RE-SAM2: Boosting Few-Shot Medical Image Segmentation via Reinforcement Learning and Ensemble Learning[C].<strong>2025 IEEE International Conference on Bioinformatics and Biomedicine (BIBM 2025)</strong>.[[Paper]](https://doi.org/10.1109/BIBM66473.2025.11356746)[[code]](https://github.com/zzzzz37/RE-SAM2)
...
- Cai Yulin, Yang Le and <strong>Zhao Bin*</strong>. DB-SKDNet: Dual-Branch Self-Knowledge Distillation with Multi-Granularity Perturbations for Robust Semi-Supervised Change Detection[C]. <strong>2025 IEEE International Conference on Systems, Man, and Cybernetics (SMC 2025)</strong>. [[Paper]](https://doi.org/10.1109/SMC58881.2025.11343402)[[code]](https://github.com/cyl1238685387/DB-SKDNet/)

- Chen Yuhan, Li You* and <strong>Zhao Bin*</strong>. ConsMatch: Semi-Supervised Medical Image Segmentation via Multi-View Contrast and Feature Consistency[C]. <strong>2025 IEEE International Conference on Systems, Man, and Cybernetics (SMC 2025)</strong>. [[Paper]](https://doi.org/10.1109/SMC58881.2025.11342848)[[code]](https://github.com/magic-fortune/ConsMatch)